...
import com.handysan.digitalsignage.Verification.*;
...
public class Registration extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        WifiManager wifiManager = (WifiManager) view.getContext().getSystemService(view.getContext().WIFI_SERVICE);
        String ipAddress = Formatter.formatIpAddress(wifiManager.getConnectionInfo().getIpAddress());
        KeyResolver codeGen = new KeyResolver();
        KeyDecipher ipGen = new KeyDecipher();
        String Code = codeGen.hashInteger(ipAddress);
